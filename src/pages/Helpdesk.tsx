...
const Helpdesk = () => {
  const conversationHistory = [
    { role: "user", content: "How do I integrate the API with my React app?", time: "10:30 AM" },
    { role: "agent", content: "I'll help you with that. First, install our SDK...", time: "10:31 AM" },
    { role: "user", content: "Got it, what's next?", time: "10:33 AM" },
  ];
            ...
            <div className="mt-6">
              ...
              <div className="p-4 rounded-lg bg-accent/10 border border-accent/20">
                <p className="font-mono text-sm text-foreground">
                  Based on your conversation history and similar resolved tickets, here's what I
                  recommend: Install our React SDK with `npm install @motionos/react-sdk`, then
                  initialize it with your API key. I'll send you a complete setup guide with code
                  examples.
                </p>
              </div>
            </div>
