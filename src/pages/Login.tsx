    ...
    <div className="min-h-screen bg-background grid-bg flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold font-mono text-primary neon-glow mb-2">
            MotionOS
          </h1>
          <p className="text-muted-foreground font-mono text-sm">Memory Layer Access</p>
        </div>
        ...
        <div className="glass-panel rounded-xl p-8">
          ...
          <Button
            ...
            className="w-full font-mono border-border hover:bg-secondary/50"
          >
